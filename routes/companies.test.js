  ...
  test("works for anon", async function () {
    ...
    expect(resp.body).toEqual({
      company: {
        ...
        logoUrl: "http://c1.img",
        jobs: [
          { id: testJobIds[0], title: "J1", equity: "0.1", salary: 1, companyName: "C1" },
          { id: testJobIds[1], title: "J2", equity: "0.2", salary: 2, companyName: "C1" },
          { id: testJobIds[2], title: "J3", equity: null, salary: 3, companyName: "C1" },
        ],
      },
    });
  });
