...
describe("get", function () {
  test("works", async function () {
    ...
    expect(company).toEqual({
      ...
      logoUrl: "http://c1.img",
      jobs: [
        { id: testJobIds[0], title: "Job1", salary: 100, equity: "0.1", companyName: "C1" },
        { id: testJobIds[1], title: "Job2", salary: 200, equity: "0.2", companyName: "C1" },
        { id: testJobIds[2], title: "Job3", salary: 300, equity: "0", companyName: "C1" },
        { id: testJobIds[3], title: "Job4", salary: null, equity: null, companyName: "C1" },
      ],
    });
  });
